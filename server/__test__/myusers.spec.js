...
describe('User API testing', () => {
  ...
  describe('Handle User creation', () => {
    ...
    it('Should return an error when a user tries to signup without an email', (done) => {
      const testUser = { ...user };
    ...
    it('Should return an error when a user tries to signup without a name', (done) => {
    ...
    it('Should return an error when a user attempts to signup without a password', (done) => {
      const testUser = { ...user };
    ...
    it('Should return an error when a user attempts to signup with a password less than 8 characters', (done) => {
      const testUser = { ...user };
    ...
    it('Should return an error if a user tries to sign in without a email', (done) => {
      const testUser = { ...user };
      delete testUser.email;
      request
        .post(userSignin)
    ...
    it('Should return an error if a user tries to sign in without a password', (done) => {
      const testUser = { ...user };
      delete testUser.password;
      request
        .post(userSignin)
    ...
    it('Should return an error if a user tries to sign in with an invalid email or password', (done) => {
      const dummyUser = {
    ...
    it('Should get the details of a user that is already logged in', (done) => {
      const testUser = { ...users[0] };
      request
        .get(`/api/v1/users/get_user?token=${testUser.tokens[0].token}`)
        .set('Connection', 'keep alive')
        .set('Content-Type', 'application/json')
        .end((err, res) => {
