        ...
        <div id="login-box">
          <div className="left">
            ...
            <div>
              ...
              />
              {errors.username && (
                <span className="help-block errors">{errors.username}</span>
              )}
            </div>
            <div>
              <input
              ...
              />
              {errors.email && (
                <span className="help-block errors">{errors.email}</span>
              )}
            </div>
            <div>
              <input
              ...
              />
              {errors.password && (
                <span className="help-block errors">{errors.password}</span>
              )}
            </div>
