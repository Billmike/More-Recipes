...
export const startGetAllRecipes = () => dispatch => axios
  .get('/api/v1/recipes')
  .then((res) => {
...
export const startAddFavoriteRecipes = id => dispatch => axios
...
export const startUpvoteRecipe = id => dispatch => axios
...
export const startDownVoteRecipe = id => dispatch => axios
